...
*/
var tables = Array.from(document.getElementsByClassName('ltable'));
var domTables = tables.map(function(v){
				var jsonObj = JSON.parse(v.value);
				var tab = buildTable(jsonObj);
				var tabDiv = document.createElement('div');
				tabDiv.appendChild(tab);
				tabDiv.setAttribute("style","border:2px solid black");
				tabDiv.classList.add('json-table');
				return tabDiv;
});

domTables.forEach(function(v){
...
console.log('venu.dasarathy@gmail.com');
